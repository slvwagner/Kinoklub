...
df_temp <- df_Abrechnung|>
  ...
  select(`Event ID`, Suisanummer, Filmtitel, Datum_display, Datum, Zeit, Besucherzahl, `Umsatz [CHF]`, `Ticketgewinn [CHF]`, `Gewinn Kioskartikel [CHF]`, `Gewinn Spezialartikel [CHF]`, `Gewinn aus Fimvorführung [CHF]`)|>
