...
* [1 Übersicht](#A_1_Übersicht)
* [2 Filmvorführung](#A_2_Filmvorführung)
    + [2.1 Kino Umsatz](#A_2.1_Kino Umsatz)
    + [2.2 Kino Besucherzahlen](#A_2.2_Kino Besucherzahlen)
    + [2.3 Filmabgaben](#A_2.3_Filmabgaben)
        + [2.3.1 Abgaben](#A_2.3.1_Abgaben)
* [3 Event](#A_3_Event)
    + [3.1 Einnahmen](#A_3.1_Einnahmen)
    + [3.2 Ausgaben](#A_3.2_Ausgaben)
* [4 Kiosk](#A_4_Kiosk)
    + [4.1 Gewinn für Kiosk Artikel](#A_4.1_Gewinn für Kiosk Artikel)
    + [4.2 Umsatz Spezialverkaufsartikel](#A_4.2_Umsatz Spezialverkaufsartikel)
    + [4.3 Ausgaben (Eventausgaben)](#A_4.3_Ausgaben (Eventausgaben))
    + [4.4 Differenz](#A_4.4_Differenz)
* [5 Gewinn / Verlust](#A_5_Gewinn / Verlust)
...
## 1 Übersicht<a name="A_1_Übersicht"></a>
...
## 2 Filmvorführung<a name="A_2_Filmvorführung"></a>
[Inhaltsverzeichnis](#Inhaltsverzeichnis)


### 2.1 Kino Umsatz<a name="A_2.1_Kino Umsatz"></a>
[Inhaltsverzeichnis](#Inhaltsverzeichnis)
...
### 2.2 Kino Besucherzahlen<a name="A_2.2_Kino Besucherzahlen"></a>
[Inhaltsverzeichnis](#Inhaltsverzeichnis)
...
### 2.3 Filmabgaben<a name="A_2.3_Filmabgaben"></a>
[Inhaltsverzeichnis](#Inhaltsverzeichnis)
...
#### 2.3.1 Abgaben<a name="A_2.3.1_Abgaben"></a>
[Inhaltsverzeichnis](#Inhaltsverzeichnis)
...
## 3 Event<a name="A_3_Event"></a>
[Inhaltsverzeichnis](#Inhaltsverzeichnis)


### 3.1 Einnahmen<a name="A_3.1_Einnahmen"></a>
[Inhaltsverzeichnis](#Inhaltsverzeichnis)
...
## 4 Kiosk<a name="A_4_Kiosk"></a>
[Inhaltsverzeichnis](#Inhaltsverzeichnis)


### 4.1 Gewinn für Kiosk Artikel<a name="A_4.1_Gewinn für Kiosk Artikel"></a>
[Inhaltsverzeichnis](#Inhaltsverzeichnis)
...
### 4.2 Umsatz Spezialverkaufsartikel<a name="A_4.2_Umsatz Spezialverkaufsartikel"></a>
[Inhaltsverzeichnis](#Inhaltsverzeichnis)
...
### 4.3 Ausgaben (Eventausgaben)<a name="A_4.3_Ausgaben (Eventausgaben)"></a>
[Inhaltsverzeichnis](#Inhaltsverzeichnis)
...
```{r echo=FALSE}
df_temp|>
  select(Spieldatum, Suisanummer, Bezeichnung, `Betrag [CHF]`)|>
  knitr::kable()
```

### 4.4 Differenz<a name="A_4.4_Differenz"></a>
[Inhaltsverzeichnis](#Inhaltsverzeichnis)
...
## 5 Gewinn / Verlust<a name="A_5_Gewinn / Verlust"></a>
[Inhaltsverzeichnis](#Inhaltsverzeichnis)
