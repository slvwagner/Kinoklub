...
c_suisa_prozent <- df_temp|>
  ...
  pull()
c_suisa_prozent <- c_suisa_prozent[1]
...
df_temp1 <- df_Tickets|>
  ...
  select(`Event ID`, Platzkategorie, Anzahl,`Verkaufspreis für Netto3 [CHF]`)|>
  rename(`Verkaufspreis [CHF]` = `Verkaufspreis für Netto3 [CHF]`)|>
  mutate(`Umsatz [CHF]` = Anzahl * `Verkaufspreis [CHF]`)
