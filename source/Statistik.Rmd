...
# Define German weekday names
german_weekdays <- c("Sonntag", "Montag", "Dienstag", "Mittwoch", "Donnerstag", "Freitag", "Samstag")

# Function to convert English weekday names to German, if necessary
convert_to_german_weekdays <- function(date) {
  english_weekdays <- c("Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday")
