...
Bis jetzt gabe es `r n` Vorführungen in `r n_days_till_now` Tagen. Das sind `r n / n_days_till_now` Shows per Tag. \
...
df_temp|>
  ...
  labs(title = "Gewinnprognose mit und ohne Sommerpause",
