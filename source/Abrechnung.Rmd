...
df_temp <- df_show|>
  filter(`Event ID` == ii)|>
  mutate(Anfang = paste0(lubridate::hour(Zeit),":", 
                         lubridate::minute(Zeit)|>as.character()|>formatC(format = "0", width = 2)|>str_replace(rebus::SPC,"0")),
